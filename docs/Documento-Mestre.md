...
Os três modos de operação oficiais da plataforma — **ECO Conversacional**, **ECO Clínica** e **ECO Pesquisa** — estão documentados por completo, com público, fluxo e objetivo de cada um, em [Arquitetura-Cientifica.md §8](Arquitetura-Cientifica.md#8-modos-de-operação-da-plataforma). Os três utilizam exatamente a mesma cadeia científica (§6.0) até a camada de Motores — nenhum modo tem fundamentação própria ou paralela.