...
> Versão 1.4 — Sprint 28; atualizado por decisão de arquitetura permanente pós-Sprint 30 ("Modos de Operação da Plataforma") para registrar que a ECO é a interface de apenas um dos modos oficiais de operação da plataforma; estendido por nova decisão de arquitetura permanente para registrar a Ética da Psicanálise (Seminário 7 de Lacan) como fundamentação da posição ética da ECO — ver [Etica-da-Psicanalise.md](Etica-da-Psicanalise.md); ajustado por decisão posterior que consolidou a organização de três modos de operação para dois; ajustado por uma terceira decisão, exclusivamente documental, que nomeia oficialmente o Modo 2 como **Laboratório** e registra a política de acesso a cada modo. Camada da [cadeia de rastreabilidade](../Arquitetura-Cientifica.md#1-cadeia-de-rastreabilidade-obrigatória) que documenta a identidade da interface conversacional do PsycheAI. Sprint exclusivamente científica e arquitetônica: nenhum código, API, banco de dados ou teste foi alterado para produzir esta documentação.
...
Adicionado por decisão de arquitetura permanente pós-Sprint 30 ("Modos de Operação da Plataforma", [Arquitetura-Cientifica.md §8](../Arquitetura-Cientifica.md#8-modos-de-operação-da-plataforma)), ajustado por decisão posterior que consolidou três modos em dois: o PsycheAI deixou de ser definido como plataforma exclusivamente conversacional. A ECO — tudo descrito nesta pasta — é a interface do **Modo 1 — ECO, destinado ao Sujeito** (o discurso nasce dentro da própria plataforma, na conversa com a ECO), uma das duas formas oficiais de operação da plataforma, ao lado do **Modo 2 — Laboratório, destinado a profissionais e pesquisadores** (material discursivo produzido fora da plataforma — sessão clínica conduzida integralmente por um profissional autorizado, ou sessões de pesquisa anonimizadas — importado e observado posteriormente; sem participação da ECO). No Modo 2, a ECO não participa — os Motores recebem o discurso por outra origem, mas produzem exatamente a mesma Representação Computacional. Todo o conteúdo desta pasta (identidade, princípios, método socrático, posição clínica, fluxo conversacional, interfaces, limites, ética) permanece válido e inalterado — descreve o Modo 1 em profundidade, não a plataforma inteira.

**Política de acesso** (terceira decisão de arquitetura permanente, exclusivamente documental): o Modo 1 — ECO é a interface pública, sem restrição além da identidade do próprio Sujeito — nada muda na experiência descrita nesta pasta. O Modo 2 — Laboratório, nesta primeira fase do projeto, é de acesso exclusivo do Administrador do PsycheAI; futuramente poderá se abrir, por sistema de permissões, a profissionais e pesquisadores autorizados — fora do escopo da versão atual. O Laboratório não é uma funcionalidade do Sujeito: é um ambiente científico da plataforma que compartilha com a ECO exatamente a mesma arquitetura científica. Detalhamento completo em [Arquitetura-Cientifica.md §8.6-8.8](../Arquitetura-Cientifica.md#86-política-de-acesso).
